...
public class StartDeathmatchThread implements Runnable{
	...
	public StartDeathmatchThread(GameManager gameManager, boolean shrinkBorder, CustomEventHandler customEventHandler){
		this.gameManager = gameManager;
		this.timeBeforePVP = 16;
	...
	public void run() {
		timeBeforePVP --;
		customEventHandler.handleDeathMatchEvent();
