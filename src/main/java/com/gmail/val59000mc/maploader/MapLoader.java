...
public class MapLoader {
	...
	public final static String DO_IMMEDIATE_RESPAWN = "doImmediateRespawn";
	...
	public void createNewWorld(Environment env){
		...
		if (env == Environment.NORMAL){
			worldName = ("uhc-"+UUID.randomUUID()+"-over-world");
		} else if (env == Environment.NETHER){
			worldName = ("uhc-"+UUID.randomUUID()+"-nether");
		} else if (env == Environment.THE_END){
			worldName = ("uhc-"+UUID.randomUUID()+"-the-end");
		} else {
			worldName = ("uhc-"+UUID.randomUUID()+"-custom");
		}
	...
	public void setWorldsStartGame() {
		...
		VersionUtils.getVersionUtils().setGameRuleValue(overworld, DO_IMMEDIATE_RESPAWN, true);
	...
	public void setBorderSize(World world, double x, double z, double size) {
