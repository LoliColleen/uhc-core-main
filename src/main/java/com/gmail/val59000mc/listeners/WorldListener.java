...
public class WorldListener implements Listener{
    ...
    public void onWorldInit(WorldInitEvent e){
        ...
        if (world.getName().equals(overworldUuid) && cfg.get(MainConfig.REPLACE_DEEPSLATE)){
            world.getPopulators().add(new ReplaceDeepslatePopulator());
        }
        if (world.getName().equals(overworldUuid) && cfg.get(MainConfig.REPLACE_COPPER)){
            world.getPopulators().add(new ReplaceCopperPopulator());
        }
