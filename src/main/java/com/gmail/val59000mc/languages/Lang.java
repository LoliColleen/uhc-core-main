...
public class Lang{
	...
	public static String ITEMS_EXODUS;
	...
	public static String ITEMS_BARBARIAN;
	...
	private void loadLangConfig() {
		...
		ITEMS_EXODUS = getString(lang, "items.exodus", "1");
		...
		ITEMS_BARBARIAN = getString(lang, "items.barbarian", "1");
