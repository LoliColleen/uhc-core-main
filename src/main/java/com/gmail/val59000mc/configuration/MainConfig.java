...
public class MainConfig extends YamlFile {
	...
	public static final BasicOption<Integer> MAX_DM_BUILDING_HEIGHT = new BasicOption<>("customize-game-behavior.max-dm-building-height", -1);
	...
	public static final BasicOption<Boolean> REPLACE_DEEPSLATE = new BasicOption<>("fast-mode.replace-deepslate", true);
	public static final BasicOption<Boolean> REPLACE_COPPER = new BasicOption<>("fast-mode.replace-copper", true);
