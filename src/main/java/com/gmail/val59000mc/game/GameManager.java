...
public class GameManager{
	...
	public GameManager() {
		...
		deathmatchHandler = new DeathmatchHandler(this, config, playerManager, mapLoader, customEventHandler);
		playerDamageHandler = new PlayerDamageHandler(this, playerManager);
		playerDeathHandler = new PlayerDeathHandler(this, scenarioManager, playerManager, config, customEventHandler, playerDamageHandler);
	...
	public void startWatchingEndOfGame(){
		for(UhcPlayer uhcPlayer : playerManager.getPlayersList()) {
			...
			if (uhcPlayer.getState() == PlayerState.PLAYING && uhcPlayer.isOnline()) {
				try {
		...
		Bukkit.getScheduler().runTaskAsynchronously(UhcCore.getPlugin(), new StartingGameThread(this, customEventHandler, mapLoader));
	...
	private void registerListeners() {
		...
		listeners.add(new PlayerDamageListener(this, playerManager, playerDamageHandler));
	...
	private void registerCommands(){
		...
		registerCommand("setscenario", new SetScenarioCommandExecutor(this, scenarioManager));
	}
